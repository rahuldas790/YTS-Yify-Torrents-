...
import rahulkumardas.ytsyifytorrents.bitlet.choker.Choker;
...
import rahulkumardas.ytsyifytorrents.bitlet.peer.Peer;
import rahulkumardas.ytsyifytorrents.bitlet.peer.PeersManager;
import rahulkumardas.ytsyifytorrents.bitlet.peer.message.Have;
import rahulkumardas.ytsyifytorrents.bitlet.peer.message.Request;
import rahulkumardas.ytsyifytorrents.bitlet.pieceChooser.PieceChooser;
import rahulkumardas.ytsyifytorrents.bitlet.pieceChooser.RouletteWheelPieceChooser;
import rahulkumardas.ytsyifytorrents.bitlet.util.Utils;
import rahulkumardas.ytsyifytorrents.bitlet.util.stream.BandwidthLimiter;
import rahulkumardas.ytsyifytorrents.bitlet.util.thread.InterruptableTasksThread;

import static rahulkumardas.ytsyifytorrents.bitlet.util.Utils.toByteBuffer;
...
public class Torrent extends InterruptableTasksThread {
    ...
    public void tick() {
        ...
        try {
            ...
            Log.i("Torrent ", "Error "+e.getMessage());
        }
    }
